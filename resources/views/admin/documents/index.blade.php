                ...
                <div class="card-body">
                    <ul class="tree-list">
                        <li>
                            ...
                            <i class="mdi mdi-folder-multiple-outline"> </i> &nbsp; Documents</span>
                            <?php

                            $storageDirectory = 'public/applications/'.Illuminate\Support\Facades\Auth::user()->company_name.'/files/';
                                                ...
                                                <li>
                                                    ...
                                                    <form id="" class="one-four" method="POST"
                                                        ...
                                                        <span
                                                            ...
                                                            <button type="submit" class="link-btn-form" title="Delete File"><i
                                                                    class="mdi mdi-delete-forever"></i></button>
                                                    </span>
                                                        <input type="hidden" name="fullPath"
                                                               value="{{$application.'/'.basename($fileItem)}}">
  ...
  @endif
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            ActiveLeftSideMenuOnLoad(".documents_menu", 0);
